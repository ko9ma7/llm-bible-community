...
export function publicConfig(env = {}) {
  return {
    supabaseUrl: env.VITE_SUPABASE_URL || env.SUPABASE_URL || PUBLIC_DEFAULTS.supabaseUrl,
    supabasePublishableKey: env.VITE_SUPABASE_PUBLISHABLE_KEY || env.SUPABASE_PUBLISHABLE_KEY || env.SUPABASE_ANON_KEY || PUBLIC_DEFAULTS.supabasePublishableKey,
    siteUrl: (env.VITE_SITE_URL || env.PUBLIC_SITE_URL || PUBLIC_DEFAULTS.siteUrl).replace(/\/$/, ''),
    repoName: env.VITE_REPO_NAME || PUBLIC_DEFAULTS.repoName
  };
}
