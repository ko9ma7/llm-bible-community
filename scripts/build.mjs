...
fs.copyFileSync(path.join(root, 'supabase', 'schema.sql'), path.join(dist, 'setup', 'schema.sql'));
if (fs.existsSync(path.join(root, 'PERMISSIONS.md'))) fs.copyFileSync(path.join(root, 'PERMISSIONS.md'), path.join(dist, 'setup', 'PERMISSIONS.md'));
